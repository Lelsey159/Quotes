...
2. Use this command to clone `$  git@github.com:Lelsey159/Quotes.git
...
To get more help on the Angular CLI use `ng help` or go check out the [Angular CLI Overview and Command Reference](https://angular.io/cli) page.This project is under the  [MIT](licence) licence.
